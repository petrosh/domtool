// append message
document.getElementById('main').acc('p', 'loader.js is loaded<br>Now requesting gh-pages ref');

// receive repo sha and load updated script
function foo(response){
  document.getElementById('main').acc('p', ['Repository gh-pages refs ' + response.data.object.sha, 'Now loading updated proceed.js from rawgit.com'].join('<br>'));
